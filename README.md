...
A two-page Power BI dashboard was created using the Gold-layer outputs generated by the PySpark pipeline.

### Sensor Maintenance Overview

The overview page contains:

- Total Faults KPI
- Maintenance Triggers KPI
- Average Fault Rate KPI
- Equipment Criticality slicer
- Faults by Equipment
- Failure Type Distribution
- Average Maintenance Cost by Criticality

![Sensor Maintenance Overview](docs/images/sensor_maintenance_overview.png)

### Maintenance Analysis

The maintenance analysis page contains:

- Average Repair Time by Failure Type
- Average Vibration by Failure Type
- Average Temperature by Failure Type
- Maintenance Triggers by Failure Type

![Maintenance Analysis](docs/images/maintenance_analysis.png)

### DAX Measures

The dashboard uses DAX measures for key business metrics, including:
...
```text
powerbi/sensor_maintenance_dashboard.pbix
```
## Key Insights
